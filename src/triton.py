...
os.environ["TRITON_CUDA_ARCH"] = "8.5"
os.environ["CUDA_DEVICE_MAX_CONNECTIONS"] = "1"
os.environ["TORCH_CUDA_ARCH_LIST"] = "8.5"  
os.environ["TORCH_TRITON_FORCE_COMPUTE_CAPABILITY"] = "85"

def setup_msvc_env():
    vs_path = "C:\\Program Files\\Microsoft Visual Studio\\2022\\Community"
    vcvars_path = f"{vs_path}\\VC\\Auxiliary\\Build\\vcvars64.bat"
    ...
    if os.path.exists(vcvars_path):
        ...
        print(f"Could not find MSVC setup script at {vcvars_path}")
        sys.exit(1)
...
def _attn_fwd(
    ...
    # Get the SEQ_LEN, HEAD_DIM, block in the Q, K, V by selecting indexding it by batch and head
    qkv_offset = (
